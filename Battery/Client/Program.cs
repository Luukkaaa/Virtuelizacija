...
namespace Client
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Relativna putanja do foldera sa datasetom 
            ...
            foreach (string filePath in csvFiles)
            {
                try
                {
                    ...
                    // Iseckamo putanju trenutnog fajla na delove
                    string[] putanjaDelovi = filePath.Split(Path.DirectorySeparatorChar);

                    // Izvlacimo nazive foldera 
                    string testId = putanjaDelovi[putanjaDelovi.Length - 3];
                    string batteryId = putanjaDelovi[putanjaDelovi.Length - 5];
                ...
                {
                    Console.WriteLine("Server trenutno nije pokrenut.");
                    break;
                }
            }
